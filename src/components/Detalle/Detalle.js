                ...
                <div className='border-t border-gray-200'>
                    <dl>
                        <div className='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                            ...
                            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>Margo Foster</dd>
                        </div>
                        ...
                        <div className='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                            ...
                            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>Aliquip ad voluptate non nulla cillum veniam do sunt duis in. Ea excepteur laborum ullamco laboris. Do incididunt ullamco nisi ea veniam veniam minim ad laborum tempor anim esse cillum aliqua. Nulla ex nostrud pariatur et minim.</dd>
                        </div>
                        <div className='bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
